...
- **Civ Game Layer**: **Block A + Block B closed**. **129 pytest.** Truth plane: `docs/TRUTH_ORDER.md`, `config/work_pack_registry.yaml`. Dashboard `/dashboard`. Debt: `docs/DEBT_REGISTER_V1.md`.
